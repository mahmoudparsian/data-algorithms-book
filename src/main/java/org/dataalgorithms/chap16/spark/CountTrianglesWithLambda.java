 ...
 *
 */
public class CountTrianglesWithLambda {
  //
  public static void main(String[] args) throws Exception {
    if (args.length < 2) {
       System.err.println("Usage: CountTrianglesWithLambda <input-path> <output-path>");
       System.exit(1);
    }
    ...
    JavaPairRDD<Long,Long> edges = lines.flatMapToPair((String s) -> {
