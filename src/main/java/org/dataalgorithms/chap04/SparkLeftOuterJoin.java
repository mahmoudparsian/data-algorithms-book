...
public class SparkLeftOuterJoin {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length < 3) {
       ...
       System.err.println("Usage: SparkLeftOuterJoin <spark-master-URL> <users> <transactions>");
       System.exit(1);
    }
    
    String sparkMasterURL = args[0];
    String usersInputFile = args[1];
    String transactionsInputFile = args[2];
    ...
    JavaPairRDD<String,Tuple2<String,String>> usersRDD = 
          //                         T       K       V
          users.mapToPair(new PairFunction<String, String, Tuple2<String,String>>() {
