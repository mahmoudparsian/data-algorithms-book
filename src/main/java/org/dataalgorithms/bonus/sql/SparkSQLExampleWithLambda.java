package org.dataalgorithms.bonus.sql;
 ...
 *
 */
public class SparkSQLExampleWithLambda {

  public static void main(String[] args) throws Exception {
    String inputPath = args[0]; // "examples/src/main/resources/people.txt"
    //
    SparkConf sparkConf = new SparkConf().setAppName("SparkSQLWithLambda");
    ...
    // <name><,><age><,><country>    
    JavaRDD<Person> people = ctx.textFile(inputPath)
            .map((String record) -> Person.buildPerson(record) 
    );
