...
/** 
 * The FrequencyComparator class enable us to compare two 
 * Tuple2<Integer, String> objects based on the first Tuple2 argument.
 *
...
public class FrequencyComparator 
   ...
   static final FrequencyComparator INSTANCE = new FrequencyComparator();
