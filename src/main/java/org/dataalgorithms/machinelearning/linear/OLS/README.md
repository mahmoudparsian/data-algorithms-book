POJO solution using Ordinary Least Squares Regression
=====================================================

* OrdinaryLeastSquaresRegressionDriver: driver for testing the built model

* OrdinaryLeastSquaresRegressionModel: builds model
