 ...
 * Description:
    ...
    CharCountDriver: submits the job to Hadoop Counting the chars.
 *
...
public class CharCountDriver  extends Configured implements Tool {
    ...
    private static Logger theLogger = Logger.getLogger(CharCountDriver.class);
    ...
    public int run(String[] args) throws Exception {
       ...
       job.setJobName("CharCountWithPairsDriver");
    ...
    public static int submitJob(String[] args) throws Exception {
       int returnStatus = ToolRunner.run(new CharCountDriver(), args);
       return returnStatus;
    }
}
